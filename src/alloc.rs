...
static mut REAL_FREE: Option<extern "C" fn(*mut libc::c_void)> = None;
static mut REAL_REALLOC: Option<extern "C" fn(*mut libc::c_void, libc::size_t) -> (*mut libc::c_void)> = None;

// This should be the first thing called in main
#[no_mangle]
